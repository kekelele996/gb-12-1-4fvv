...
LOCKED_MATERIAL_DETAIL = '该材料已随申请递交固化，不能移除或更换。'
...
class MaterialItemViewSet(viewsets.ModelViewSet):
    ...
    def _lock_conflict(self):
        return Response({'detail': LOCKED_MATERIAL_DETAIL}, status=status.HTTP_409_CONFLICT)
