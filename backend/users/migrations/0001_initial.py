    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', '学生'), ('consultant', '顾问'), ('admin', '管理员')], default='student', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_degree', models.CharField(blank=True, max_length=50)),
                ...
                ('consultant', models.ForeignKey(blank=True, limit_choices_to={'role': 'consultant'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to=settings.AUTH_USER_MODEL)),
