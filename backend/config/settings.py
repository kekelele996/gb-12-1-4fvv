...
INSTALLED_APPS = [
    ...
    'materials',
    'timelines',
    'messages.apps.ChatMessagesConfig',
    'analytics',
    'submissions',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'study_abroad'),
        'USER': os.environ.get('POSTGRES_USER', 'study_abroad'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'study_abroad_password'),
...
if os.environ.get('MINIO_ENDPOINT'):
    ...
    AWS_STORAGE_BUCKET_NAME = os.environ.get('MINIO_BUCKET_NAME', 'study-abroad')
